    ...
    <main class="app-main">
              ...
              <select class="form-select" id="produitSelect" required>
                ...
                <?php foreach($produits as $produit): ?>
                  <option value="<?= esc($produit['id']) ?>" data-prix="<?= esc($produit['prix']) ?>">
                    <?= esc($produit['designation']) ?> — <?= number_format(esc($produit['prix']), 2, ',', ' ') ?> Ar
                  </option>
                <?php endforeach; ?>
              </select>
      ...
      <div class="receipt-card mb-4">
        ...
        <div class="receipt-total">
          ...
          <span class="amount" id="totalAmount">0,00 Ar</span>
        </div>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="d-flex justify-content-between fw-semibold">
            ...
            <span class="qty-cell" id="modalRecapTotal">0,00 Ar</span>
          </div>
        </div>
